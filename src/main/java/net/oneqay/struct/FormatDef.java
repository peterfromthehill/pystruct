...
public class FormatDef {
    ...
    public FormatDef init(final char _name, final int _size, final int _alignment) {
        this.name = _name;
        this.size = _size;
    ...
    protected int doPack(final ByteStream buf, final int _count, final int _pos, final Object[] args) {
        int count = _count;
        int pos = _pos;
